...
export default {
  ...
  methods: {
    Calculate() {
      ...
      $.ajax({
        url: `http://localhost:8000/deposit_calculate?${$.param(input_data)}`,
        type: "GET",
  ...
  <div class="container mt-5">
    <div class="container">
      ...
      <div class="mb-4 input-group">
        ...
        <!-- tooltip -->
        <span class="input-group-text">
          <span class="tt" data-bs-placement="bottom" title="The interest rate at which you are going to repay the loan">
            <i class="bi bi-question-circle text-muted"></i>
          </span>
        </span>
      </div>
